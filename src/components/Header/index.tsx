...
function Header() {
  ...
  return (
    <header>
      ...
      <nav
        className={isNavVisibility ? "block" : "invisible md:block md:visible"}
      >
        <div className={isNavVisibility ? "header__menu" : undefined}>
          <ul
            className={
              isNavVisibility
                ? "flex flex-col items-center justify-center list-none gap-6"
                : "hidden md:flex md:flex-row list-none gap-4"
            }
          >
            {sectionList.map((section) => (
              <li
                ...
                className={
                  isNavVisibility
                    ? "c-btn c-btn-li c-btn-li--icon"
                    : "c-btn c-btn-li c-btn-li--full"
                }
              >
