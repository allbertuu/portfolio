...
export default function SkillCard({
  ...
  return (
    <div
      id={`c-skill-card-${name}`}
      className="intervalCardRevealSmall c-skill-card flex flex-col sm:flex-row p-5 gap-4"
      onMouseOver={toggleCardColor}
      onMouseOut={toggleCardColor}
    >
