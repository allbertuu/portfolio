...
function App() {
  ...
  return (
    <>
      ...
      <main>
        <section id='s-welcome' className='grid lg:grid-cols-2 content-center justify-items-center relative h-screen gap-4'>
          <div>
            <div>
        ...
        <section id='s-about-me' className='grid md:grid-cols-2 items-center justify-items-center py-20 lg:py-32 pb-32 gap-12 md:gap-10 lg:gap-0'>
          ...
          <div className="intervalCardReveal">
            ...
            <p className="delayMediumReveal">
              Meu nome é Alberto Vinícius A. dos Santos, tenho 19 anos e sou desenvolvedor Front-end. <br />
              ...
              Sou um jovem ambicioso, com uma sede invejável e constante por conhecimento.
            </p>
          </div>
        </section>
